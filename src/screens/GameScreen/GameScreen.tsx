...
export const GameScreen: FC = () => {
    ...
    useEffect(() => {init().catch(console.log);}, [])
    ...
    return loading
        ? <>Loading</>
        : <GameScreen1 nomination={nomination} questions={questions}/>;
};

export const GameScreen1: FC<{ questions: any; nomination: number }> = (props) => {
    ...
    const answersArray = data.map((item: any) => item.answers);
    ...
    return (
        <div className={'game-screen'}>
            ...
            <Modal
                ...
                showCloseIcon={false}
                onClose={() => {setQuestionActive(!isQuestionActive); setQ(null)}}
                classNames={{
